...
<html><head>
    ...
    <base href="http://localhost/apppakartumbuhan/">
	<link rel="icon" href="gambar/logo/logotim.png">
    ...
    <link rel="shortcut icon" href="logotim.ico" type="image/x-icon">
    <!-- jQuery 2.1.4 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>INC</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Inception</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Inception</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2023 - Made with by Inception</div></strong>
      </footer>
